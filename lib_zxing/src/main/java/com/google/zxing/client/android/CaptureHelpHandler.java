 ...
 */
public final class CaptureHelpHandler extends Handler {

    private static final String TAG = CaptureHelpHandler.class.getSimpleName();

    private final Activity activity;
    private final CaptureHelp help;
    private final DecodeHelpThread decodeThread;
