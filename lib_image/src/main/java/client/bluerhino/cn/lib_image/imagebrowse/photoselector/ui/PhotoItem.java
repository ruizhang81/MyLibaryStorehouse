...
public class PhotoItem extends LinearLayout implements OnCheckedChangeListener,
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        if (!listener.onCheckedChanged(photo, this, isChecked)) {
    ...
    public void setImageDrawable(final PhotoModel photo) {
		 ...
		 * Random().nextInt(10));
		 */
        ImageLoad.loadLocalImage(getContext(), ivPhoto, "file://" + photo.getOriginalPath());
    }
    ...
    public interface onPhotoItemCheckedListener {
        boolean onCheckedChanged(PhotoModel photoModel,
